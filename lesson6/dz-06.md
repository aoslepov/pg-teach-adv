...
Устанавливаем wal-g на реплику
```
...
Задаём конфиг vim /var/lib/postgresql/walg.json  
Для примера архивация сделана локально, в проде можно использовать minio, enc..   
```
{
...
Настраиваем архивацию wal-файлов postgres.auto.conf
```
wal_level=replica
archive_mode=on
archive_timeout=60
...
#wal-g не умеет работать с файлами сокетов, поэтому переносим файл за PGDATA директорию
...
Проверяем корректность архивации wal-файлов
```
root@pg-teach-01:/var/lib/postgresql# tail -f /var/log/postgresql/archive_command.log
INFO: 2023/10/04 18:59:08.697492 FILE PATH: 000000040000000000000010.br
INFO: 2023/10/04 19:00:09.109559 FILE PATH: 000000040000000000000011.br
INFO: 2023/10/04 19:01:08.448113 FILE PATH: 000000040000000000000012.br
```

Делаем бекап
```
root@pg-teach-01:/var/lib/postgresql# wal-g --config /var/lib/postgresql/walg.json backup-push /var/lib/postgresql/data/patroni
INFO: 2023/10/04 19:09:37.970007 Couldn't find previous backup. Doing full backup.
INFO: 2023/10/04 19:09:37.986321 Calling pg_start_backup()
INFO: 2023/10/04 19:09:38.140420 Starting a new tar bundle
INFO: 2023/10/04 19:09:38.140491 Walking ...
INFO: 2023/10/04 19:09:38.140984 Starting part 1 ...
INFO: 2023/10/04 19:09:38.548668 Packing ...
INFO: 2023/10/04 19:09:38.550390 Finished writing part 1.
INFO: 2023/10/04 19:09:38.550553 Starting part 2 ...
INFO: 2023/10/04 19:09:38.550591 /global/pg_control
INFO: 2023/10/04 19:09:38.551124 Finished writing part 2.
INFO: 2023/10/04 19:09:38.551152 Calling pg_stop_backup()
INFO: 2023/10/04 19:09:39.371116 Starting part 3 ...
INFO: 2023/10/04 19:09:39.371211 backup_label
INFO: 2023/10/04 19:09:39.371222 tablespace_map
INFO: 2023/10/04 19:09:39.371671 Finished writing part 3.
INFO: 2023/10/04 19:09:39.383352 Wrote backup with name base_000000040000000000000013

-- смотрим список бекапов
root@pg-teach-01:/var/lib/postgresql# wal-g --config /var/lib/postgresql/walg.json backup-list
name                          modified             wal_segment_backup_start
base_000000040000000000000013 2023-10-04T19:09:39Z 000000040000000000000013
```

Проверяем таймлайн для wal-файлов
```
root@pg-teach-01:/var/lib/postgresql# wal-g --config /var/lib/postgresql/walg.json wal-verify timeline integrity
INFO: 2023/10/04 19:11:02.692846 Current WAL segment: 000000040000000000000014
INFO: 2023/10/04 19:11:02.695735 Building check runner: timeline
INFO: 2023/10/04 19:11:02.695767 Running the check: timeline
WARNING: 2023/10/04 19:11:02.695809 Could not parse the timeline Id from 000000040000000000000013.00000028.backup.br. Skipping...
INFO: 2023/10/04 19:11:02.695819 Building check runner: integrity
INFO: 2023/10/04 19:11:02.696429 Detected earliest available backup: base_000000040000000000000013
INFO: 2023/10/04 19:11:02.696458 Running the check: integrity
[wal-verify] integrity check status: OK
[wal-verify] integrity check details:
+-----+--------------------------+--------------------------+----------------+--------+
| TLI | START                    | END                      | SEGMENTS COUNT | STATUS |
+-----+--------------------------+--------------------------+----------------+--------+
|   4 | 000000040000000000000013 | 000000040000000000000013 |              1 |  FOUND |
+-----+--------------------------+--------------------------+----------------+--------+
