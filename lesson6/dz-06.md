...
```
root@pg-teach-01:~# patronictl  -c /etc/patroni.yml switchover pgteachcluster
Current cluster topology
+ Cluster: pgteachcluster (7286366463888316219) --+----+-----------+
| Member      | Host        | Role    | State     | TL | Lag in MB |
+-------------+-------------+---------+-----------+----+-----------+
| pg-teach-01 | 10.128.0.19 | Replica | streaming |  2 |         0 |
| pg-teach-02 | 10.128.0.30 | Leader  | running   |  2 |           |
| pg-teach-03 | 10.128.0.22 | Replica | running   |  1 |        16 |
+-------------+-------------+---------+-----------+----+-----------+
Primary [pg-teach-02]: pg-teach-02
Candidate ['pg-teach-01', 'pg-teach-03'] []: pg-teach-01
When should the switchover take place (e.g. 2023-10-05T09:40 )  [now]: 
Are you sure you want to switchover cluster pgteachcluster, demoting current leader pg-teach-02? [y/N]: y
2023-10-05 08:40:22.75754 Successfully switched over to "pg-teach-01"
+ Cluster: pgteachcluster (7286366463888316219) +----+-----------+
| Member      | Host        | Role    | State   | TL | Lag in MB |
+-------------+-------------+---------+---------+----+-----------+
| pg-teach-01 | 10.128.0.19 | Leader  | running |  2 |           |
| pg-teach-02 | 10.128.0.30 | Replica | stopped |    |   unknown |
| pg-teach-03 | 10.128.0.22 | Replica | running |  1 |        16 |
+-------------+-------------+---------+---------+----+-----------+
root@pg-teach-01:~# patronictl  -c /etc/patroni.yml list
+ Cluster: pgteachcluster (7286366463888316219) --+----+-----------+
| Member      | Host        | Role    | State     | TL | Lag in MB |
+-------------+-------------+---------+-----------+----+-----------+
| pg-teach-01 | 10.128.0.19 | Leader  | running   |  3 |           |
| pg-teach-02 | 10.128.0.30 | Replica | streaming |  3 |         0 |
| pg-teach-03 | 10.128.0.22 | Replica | streaming |  3 |         0 |
+-------------+-------------+---------+-----------+----+-----------+
...
Восстанавливать кластер будем с pg-teach-03. Стопаем на нём патрони: systemctl stop patroni  

Для проверки восстановления из wal добавляем на мастер pg-teach-01 ещё записей
```
insert into test (i) select * from generate_series(1,100) as i;
...
На восстанавливаемой ноде pg-teach-03:  
Добавляем параметры в /etc/patroni.yml в раздел postgres->parametres  
```
postgres
  parametres
    archive_mode: on
    ...
    archive_command: '/usr/local/bin/wal-g --config /var/lib/postgresql/walg.json wal-push "%p" >> /var/log/postgresql/archive_command.log 2>&1'
    unix_socket_directories: '/var/lib/postgresql'
    restore_command: 'wal-g wal-fetch --config /var/lib/postgresql/walg.json "%f" "%p" >> /var/log/postgresql/restore_command.log 2>&1'
```

Правим параметры кластера в /etc/patroni.yml для того, чтобы при старте инициализировать новый  
```
scope: pgnew
namespace: /newcluster/
```

Удаляем каталог с данными и восстанавливаем бекап  
```
rm -rf /var/lib/postgresql/data/patroni
wal-g --config /var/lib/postgresql/walg.json backup-fetch /var/lib/postgresql/data/patroni LATEST
```

Проверяем флаг стендбай сигнал  
```
ll /var/lib/postgresql/data/patroni/standby.signal
-rw------- 1 postgres postgres 0 Oct  5 14:14 /var/lib/postgresql/data/patroni/standby.signal
```
...
Oct 05 14:57:37 pg-teach-03 patroni[10577]: 2023-10-05 14:57:37,883 INFO: no action. I am (pg-teach-03), the leader with the lock
Oct 05 14:57:27 pg-teach-03 patroni[10577]: 2023-10-05 14:57:27,987 INFO: no action. I am (pg-teach-03), the leader with the lock
Oct 05 14:57:27 pg-teach-03 patroni[10634]: 2023-10-05 14:57:27.299 UTC [10634] LOG:  checkpoint complete: wrote 8 buffers (0.0%); 0 WAL file(s) added, 0 removed, 0 recycled; write=0.509 s, sync=0.009 s, total=>
Oct 05 14:57:26 pg-teach-03 patroni[10632]: 2023-10-05 14:57:26.766 UTC [10632] LOG:  database system is ready to accept connections
Oct 05 14:57:26 pg-teach-03 patroni[10634]: 2023-10-05 14:57:26.762 UTC [10634] LOG:  checkpoint starting: force
Oct 05 14:57:26 pg-teach-03 patroni[10636]: 2023-10-05 14:57:26.757 UTC [10636] LOG:  archive recovery complete
Oct 05 14:57:26 pg-teach-03 patroni[10636]: 2023-10-05 14:57:26.748 UTC [10636] LOG:  restored log file "00000003.history" from archive
Oct 05 14:57:25 pg-teach-03 patroni[10636]: 2023-10-05 14:57:25.684 UTC [10636] LOG:  selected new timeline ID: 4
Oct 05 14:57:24 pg-teach-03 patroni[10636]: 2023-10-05 14:57:24.971 UTC [10636] LOG:  restored log file "000000030000000000000010" from archive
Oct 05 14:57:24 pg-teach-03 patroni[10636]: 2023-10-05 14:57:24.744 UTC [10636] LOG:  last completed transaction was at log time 2023-10-05 14:18:23.482491+00
Oct 05 14:57:24 pg-teach-03 patroni[10636]: 2023-10-05 14:57:24.744 UTC [10636] LOG:  redo done at 0/10000110 system usage: CPU: user: 0.00 s, system: 0.00 s, elapsed: 2.75 s
Oct 05 14:57:24 pg-teach-03 patroni[10636]: 2023-10-05 14:57:24.744 UTC [10636] LOG:  received promote request
Oct 05 14:57:23 pg-teach-03 patroni[10702]: server promoting
Oct 05 14:57:23 pg-teach-03 patroni[10577]: 2023-10-05 14:57:23,729 INFO: promoted self to leader by acquiring session lock
Oct 05 14:57:23 pg-teach-03 patroni[10577]: 2023-10-05 14:57:23,646 WARNING: Could not activate Linux watchdog device: Can't open watchdog device: [Errno 2] No such file or directory: '/dev/watchdog'
Oct 05 14:57:23 pg-teach-03 patroni[10577]: 2023-10-05 14:57:23,622 INFO: establishing a new patroni connection to the postgres cluster
Oct 05 14:57:23 pg-teach-03 patroni[10697]: 10.128.0.24:5432 - accepting connections

root@pg-teach-03:/etc# patronictl -c /etc/patroni.yml list  
+ Cluster: pgnew (7286471208087198699) --------+----+-----------+
| Member      | Host        | Role   | State   | TL | Lag in MB |
+-------------+-------------+--------+---------+----+-----------+
| pg-teach-03 | 10.128.0.24 | Leader | running |  4 |           |
+-------------+-------------+--------+---------+----+-----------+
```

Смотрим что данные подтянулись с wal-ов  
```
...
Подключаем к новому кластеру остальные ноды предыдущего кластера  
Стопаем патрони  
```
systemctl stop patroni
```

Правим параметры кластера в /etc/patroni.yml на новые  
```
scope: pgnew
namespace: /newcluster/
```
...
Удаляем данные из PGDATA и стартуем патрони  
Данные подтянутся на ноды через basebackup  
```
rm -rf /var/lib/postgresql/data/patroni
systemctl start patroni


Oct 05 15:25:09 pg-teach-02 patroni[10096]: 2023-10-05 15:25:09,454 INFO: no action. I am (pg-teach-02), a secondary, and following a leader (pg-teach-03)
Oct 05 15:25:09 pg-teach-02 patroni[10096]: 2023-10-05 15:25:09,383 INFO: establishing a new patroni connection to the postgres cluster
Oct 05 15:25:09 pg-teach-02 patroni[10096]: 2023-10-05 15:25:09,383 INFO: Lock owner: pg-teach-03; I am pg-teach-02
Oct 05 15:25:09 pg-teach-02 patroni[10159]: 10.128.0.15:5432 - accepting connections
Oct 05 15:25:09 pg-teach-02 patroni[10157]: 10.128.0.15:5432 - accepting connections
Oct 05 15:25:08 pg-teach-02 patroni[10152]: 2023-10-05 15:25:08.511 UTC [10152] LOG:  started streaming WAL from primary at 0/15000000 on timeline 4
Oct 05 15:25:08 pg-teach-02 patroni[10147]: 2023-10-05 15:25:08.479 UTC [10147] LOG:  database system is ready to accept read-only connections
Oct 05 15:25:08 pg-teach-02 patroni[10151]: 2023-10-05 15:25:08.478 UTC [10151] LOG:  consistent recovery state reached at 0/14000100
Oct 05 15:25:08 pg-teach-02 patroni[10151]: 2023-10-05 15:25:08.473 UTC [10151] LOG:  redo starts at 0/14000028
Oct 05 15:25:08 pg-teach-02 patroni[10151]: 2023-10-05 15:25:08.463 UTC [10151] LOG:  entering standby mode
Oct 05 15:25:08 pg-teach-02 patroni[10151]: 2023-10-05 15:25:08.438 UTC [10151] LOG:  database system was interrupted; last known up at 2023-10-05 15:25:04 UTC
Oct 05 15:25:08 pg-teach-02 patroni[10147]: 2023-10-05 15:25:08.411 UTC [10147] LOG:  listening on Unix socket "/var/lib/postgresql/.s.PGSQL.5432"
Oct 05 15:25:08 pg-teach-02 patroni[10147]: 2023-10-05 15:25:08.404 UTC [10147] LOG:  listening on IPv4 address "10.128.0.15", port 5432
Oct 05 15:25:08 pg-teach-02 patroni[10147]: 2023-10-05 15:25:08.404 UTC [10147] LOG:  starting PostgreSQL 15.4 (Ubuntu 15.4-2.pgdg22.04+1) on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 11.4.0-1ubuntu1~22.04) >
Oct 05 15:25:08 pg-teach-02 patroni[10148]: 10.128.0.15:5432 - no response
Oct 05 15:25:08 pg-teach-02 patroni[10096]: 2023-10-05 15:25:08,356 INFO: postmaster pid=10147
Oct 05 15:25:07 pg-teach-02 patroni[10096]: 2023-10-05 15:25:07,865 INFO: bootstrap from leader 'pg-teach-03' in progress
Oct 05 15:25:07 pg-teach-02 patroni[10096]: 2023-10-05 15:25:07,816 INFO: Lock owner: pg-teach-03; I am pg-teach-02
Oct 05 15:25:07 pg-teach-02 patroni[10096]: 2023-10-05 15:25:07,621 INFO: bootstrapped from leader 'pg-teach-03'
Oct 05 15:25:07 pg-teach-02 patroni[10096]: 2023-10-05 15:25:07,620 INFO: replica has been created using basebackup
Oct 05 15:25:04 pg-teach-02 patroni[10096]: 2023-10-05 15:25:04,016 INFO: trying to bootstrap from leader 'pg-teach-03'
Oct 05 15:25:04 pg-teach-02 patroni[10096]: 2023-10-05 15:25:03,964 INFO: Lock owner: pg-teach-03; I am pg-teach-02
Oct 05 15:25:03 pg-teach-02 patroni[10096]: 2023-10-05 15:25:03,906 INFO: No PostgreSQL configuration items changed, nothing to reload.
Oct 05 15:25:03 pg-teach-02 patroni[10096]: 2023-10-05 15:25:03,858 INFO: Selected new etcd server http://etcd-03:2379
```

Смотрим статус нового кластера
```
root@pg-teach-03:/etc# patronictl -c /etc/patroni.yml list
+ Cluster: pgnew (7286471208087198699) -----------+----+-----------+
| Member      | Host        | Role    | State     | TL | Lag in MB |
+-------------+-------------+---------+-----------+----+-----------+
| pg-teach-01 | 10.128.0.12 | Replica | streaming |  4 |         0 |
| pg-teach-02 | 10.128.0.15 | Replica | streaming |  4 |         0 |
| pg-teach-03 | 10.128.0.24 | Leader  | running   |  4 |           |
+-------------+-------------+---------+-----------+----+-----------+
```
